...
import './servitem.css'
function ServItem({icon , title , text}) {
  return (
    ...
    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature fr. Richard McClintock,</p>
